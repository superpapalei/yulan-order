      ...
      <div v-show="isCheck" class="checkTable">
        <table class="" style="width:100%;font-size:12px">
          ...
          <tr>
            ...
            <td >供应商联系人电话：</td>
            <td style="width:300px">{{ DeliverData_1.LINKMAN_TEL }}</td>
          </tr>
          <tr>
            <td>物流公司：</td>
...
export default {
  ...
  methods: {
    ...
    _EditDetail(val) {
      ...
      this.ruleForm_1.dateValue = this.$options.filters.datatrans(val.INVOICE_DATE);
      this.submit.INVOICE_DATE = this.$options.filters.datatrans(val.INVOICE_DATE) ;

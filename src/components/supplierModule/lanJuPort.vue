                  ...
                  <div>
                    <body margin:0>
                      <el-table
                        ...
                        style="width:100%;"
                      >
                        <el-table-column width="70" label="inner名称">
                          <template slot-scope="scope">{{
                            getTypeName(scope.row.cl_name)
                          }}</template>
                        </el-table-column>
                        <el-table-column width="120" label="inner编码">
                          <template slot-scope="scope"
                            >{{ scope.row.item_no }}
                          </template>
                        </el-table-column>
            ...
            <tbody>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <div>
                    <el-button @click="downLoad()" type="primary" size="small"
                      >导出Excel</el-button
                    >
                  </div>
                </td>

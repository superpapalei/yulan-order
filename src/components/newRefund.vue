      ...
      <div >
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr >
            ...
            <td style="font-size:10px;height:15px;text-align:left;" colspan="3">{{submit.CREATE_TS}}</td>
            ...
            <td style="font-size:10px;height:15px;text-align:left;" colspan="3">{{submit.DEAL_TS}}</td>
            <td >
              <el-button
                type="primary"
                size="small"
      ...
      <div class="table-c" style="margin-top:5px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td style="height:15px" colspan="2">{{submit.FIRST_AUDITION}}</td>
          ...
          <tr>
            <td class="grayTD"  style="width:15%;height:15px">产品/项目</td>
            ...
            <td class="grayTD"  style="width:17%;height:15px">质量问题</td>
            <td class="grayTD"  style="width:20%;height:15px">处理意见</td>
          </tr>
      ...
      <div class="table-c" style="margin-top:5px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr v-if="submit.RETURN_TYPE=='客户邮寄'">
            ...
            <td style="height:15px" colspan="6">        <!-- 一个新的数据查询方法：退货信息，然后将需要的字段拼在一起-->  
              <el-select
                v-if="isRefundAdd"
                style="width:99%;"
          ...
          <tr v-for="(item,index) of processDetail" :key="index">
            ...
            <td colspan="1" rowspan="1" style="height:15px">                 
              <el-select
                style="height:15px;width:100%;padding:0px 0px 0px 0px;"
...
import { getCustomerInfo,getPackDetailInfo,getReturnInfo,getReturnInfo2 } from "@/api/orderListASP";
import {
  GetAllCompensation,
  GetCompensationById,
  UpdatePrintedById,
